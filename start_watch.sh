...
tail -f -n +1 $SERVER_DIR/infer.log | python3 $SERVER_DIR/logwatch_json.py --control_server_url $REPORT_ADDR --backend 'hf_tgi' --data_dict '{"id":'$CONTAINER_ID'}' > $SERVER_DIR/watch.log 2>&1 &
